<aside class="sidebar">
    ...
    <div class="side-inner">
        ...
        <div class="nav-menu">
            <ul>
                <li class="active"><a href="../main/index.php" class="d-flex align-items-center"><span class="wrap-icon mr-3"><i class="fa-sharp fa-solid fa-house"></i></span><span class="menu-text">Dashboard</span></a></li>
                ...
                <li><a href="../registration/expense.php" class="d-flex align-items-center"><span class="wrap-icon mr-3"><i class="fa-regular fa-circle-down"></i></span><span class="menu-text">Depesas</span></a></li>
