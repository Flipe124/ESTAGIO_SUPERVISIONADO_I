            ...
            <div id="login-box">
                ...
                <form method="post" id="form-login" name="form_login">
                    ...
                    <div class="col-md-12 mt-2">
                        ...
                        <div class="input-group">
                            <input class="form-control" id="password-repeat" name="password_repeat" type="password" placeholder="confirme a senha">
                            <button class="btn button-eye" id="button-eye-repeat" type="button"><i id="icon-eye" class="fa-solid fa-eye"></i></button>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="text-danger" id="error-msg-password-repeat"></div>
                    </div>
