    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-primary text-light">
                <h5 class="modal-title"><b>EDITAR DESPESA</b></h5>
            ...
            <div class="modal-body">
                <form action="" method="post" name="form_update" id="form-update">
                    ...
                    <div class="modal-footer mt-3" id="footer-modal-update">
                        <button type="button" class="btn btn-danger" id="button-delete-expense" data-id="51">EXCLUIR</button>
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CANCELAR</button>
                        <button type="button" class="btn btn-success" id="button-update-expense">SALVAR</button>
                    </div>
                </form>
            </div>
        </div>
