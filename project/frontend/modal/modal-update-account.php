                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="update-input-name-account" placeholder="Nome" maxlength="30">
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="update-input-balance-account" placeholder="Saldo atual" oninput="formatValue(this)" maxlength="16">
