                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2">
                            ...
                            <div class="form-check form-switch mb-3">
                                <input class="form-check-input" type="checkbox" role="switch" id="update-input-status-operation" checked>
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="update-input-description-operation" placeholder="Descrição" maxlength="30">
